...
public class UseLambda {
	...
	public static void main(String[] args) {
		...
		Inter1 in1=()->{ System.out.println("반환형 없고 매개변수 없는 형의 method를 구현."); };
		//호출 : method를 호출하면 lambda식으로 정의한 코드가 실행된다.
		in1.test();
		
		//매개변수명은 달라도 된다. (데이터형만 같으면 됨)
		Inter2 in2 = (String name)->{System.out.println("반환형 없고, 매개변수 있는 형의 method 구현 : " + name);};
		//호출
		in2.test("김다은");
		
		//
		Inter3 in3 = ()->{return "오늘은 월요일 입니다. ^ㅇ^";};
		String msg = in3.test();
		System.out.println("반환형 있고, 매개변수 없는 형의 method 구현 : "+msg);
		
		
		Inter4 in4 = (String name)->{return name + "님 안녕하세요?";};
		msg = in4.test("김다은");
		System.out.println("반환형 있고, 매개변수 있는 형의 metod 구현 : "+msg);
